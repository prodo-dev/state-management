...
| ReduxZero | https://github.com/redux-zero/redux-zero | 1.8k | https://github.com/redux-zero/redux-zero#typescript | not mentioned | Simple | store, actions, no reducers | Middleware | Yes + integrates with Redux DevTools | ? |
