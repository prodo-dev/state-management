...
| Parket _(heavily inspired by mobx-state-tree, but smaller)_ | https://github.com/ForsakenHarmony/parket | 408 | not mentioned | not mentioned | Medium? | proxies, symbols, decorators, observe, connect, unistore | not mentioned | no | no |
...
| Apollo Link State | https://github.com/apollographql/apollo-link-state _(now in Apollo Client core)_ | 1.4k | Apollo provides tools to generate types | | | Medium (https://www.apollographql.com/docs/link/links/state/)| | https://github.com/apollographql/apollo-client-devtools | no |
