...
| Framework/Library | Link | GitHub Stars | TypeScript support | Performance | API Complexity | Abstract concepts | Extensibility | Devtools | Time travel | Automation |
| - | - | - | - | - | - | - | - | - | - | - |
...
| Prodo | https://github.com/prodo-dev/prodo | 63 | "First class support for TypeScript" | "Blazingly fast re-rendering" | "Absolutely minimal boilerplate" | model, store, watch, dispatch, actions | [Plugins](https://docs.prodo.dev/basics/plugins/) | https://docs.prodo.dev/basics/devtools/ | WIP | TBD
